        ...
        <div class="col-12">
            ...
            <div class="card mt-4">
                <div class="card-header">
                    <h6 class="card-title">Pengeluaran<button class="btn btn-success btn-sm pull-right btn-tambah"> <i class="fa fa-plus"></i> Tambah</button></h6>
                </div>
                <div class="card-body">
                    <table class="table table-striped" id="example">
                        ...
                        <tbody>
                            <?php $no = 1;
                            foreach ($pengeluaran->getResult() as $r) { ?>
                                <tr>
                                    <td><?= $no++ ?>.</td>
                                    ...
                                    <td>
                                        <button class="btn btn-info btn-sm btn-edit" data-id="<?= $r->id_pengeluaran ?>" data-nama="<?= $r->nama_pengeluaran ?>" data-tanggal="<?= $r->tanggal_pengeluaran ?>" data-biaya="<?= $r->biaya_pengeluaran ?>"> <i class="fa fa-pencil"></i> Edit</button>
                                        <button class="btn btn-danger btn-sm btn-hapus" data-id="<?= $r->id_pengeluaran ?>"><i class="fa fa-trash"></i> Hapus</button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
            ...
            <div class="modal-content">
                ...
                <form id="form-edit" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="">Biaya Pengeluaran:</label>
                            <input type="number" name="biaya_pengeluaran" id="biaya_pengeluaran" class="form-control">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tidak</button>
                ...
                <form id="form-hapus" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group d-none">
                            ...
                            <input type="text" name="id_pengeluaran" id="id_pengeluaran_hapus" class="form-control">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tidak</button>
