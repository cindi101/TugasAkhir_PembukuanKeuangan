        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="card mt-4" id="contentToPrint">
                <div class="card-header">
                    <h6 class="card-title">Laporan Pengeluaran <?= TanggalIndo($dari) ?> - <?= TanggalIndo($sampai) ?></h6>
                </div>
                <div class="card-body">
                    <button class="btn btn-sm btn-success" onclick="fnExcelReport('tabel_laporan');">Excel</button>
                    <a class="btn btn-sm btn-danger" href="<?= base_url('laporan/perperiode/cetakpdf/' . $dari . '/' . $sampai . '/0') ?>">PDF</a>
