...
<nav class="navbar navbar-expand-lg navbar-light border-bottom py-0 fixed-top bg-white">
    <div class="container-fluid">
        <a class="navbar-brand d-flex justify-content-start align-items-center border-end" href="<?= base_url() ?>">
                ...
                <?php if (!empty(session('logged_in'))) { ?>
                    ...
                    <div class="dropdown ms-1">
                        <button class="btn btn-link p-0 position-relative" type="button" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            <picture>
                                <img class="f-w-10 rounded-circle" src="<?= base_url() ?>assets/apollo_template/assets/images/profile-small.jpeg" alt="HTML Bootstrap Admin Template by Pixel Rocket">
                            </picture>
                        ...
                        <ul class="dropdown-menu dropdown-md dropdown-menu-end" aria-labelledby="profileDropdown">
                            <li class="d-flex py-2 align-items-start">
                                ...
                                <div class="d-flex align-items-start justify-content-between flex-grow-1">
                                    <div>
                                        <p class="lh-1 mb-2 fw-semibold text-body"><?= session('nama') ?></p>
                                        <p class="text-muted lh-1 mb-2 small"><?= session('level') ?></p>
                                    </div>
                            ...
                            <li><a class="dropdown-item d-flex align-items-center" href="<?= base_url() ?>pages/proses_logout">Logout</a></li>
                        </ul>
